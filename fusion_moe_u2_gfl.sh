...
CFG="fedbiscuit_script/tldr/tldr_choice_qwen_fusion_moe_config_u2.yaml"
...
run_one () {
  ...
  local save_path="checkpoints_1.0/tldr_choice_qwen_fusionmoe_u2_${ema}.ckpt"
  local outdir_path="exp/tldr/choice_qwen/gfl/fusionmoe_u2_1.0_${ema}"
