...
accelerate launch \
  ...
  eval.outdir "exp/tldr/choice_qwen/pfl_anal/aggregation_analysis_u4_1.0/raw" \
  outdir "exp/tldr/choice_qwen/pfl_anal/aggregation_analysis_u4_1.0/" \
  model.load_from_local_pretrained_model_path "checkpoints_1.0/final_tldr_choice_qwen_aggregation_analysis_u4_global_only_round_250.ckpt" \
