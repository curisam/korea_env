...
CFG="fedbiscuit_script/tldr/finetune_fusion_moe_config_u5.yaml"
...
run_one () {
  local ema="$1"
  local outdir_path="exp/tldr/choice_qwen/pfl/fusionmoe_u5_1.0_${ema}"

  # 동적으로 경로 업데이트
  local load_grouping_weights_path="exp/gfl/fusionmoe_u5_1.0_${ema}/grouping_weights_round180_beta${ema}.json"
  local pretrained_model_path="checkpoints_1.0/final_tldr_choice_qwen_fusionmoe_u5_${ema}_round_200.ckpt"
  local eval_outdir="exp/tldr/choice_qwen/pfl/fusionmoe_u5_1.0_${ema}/raw"
  local save_outdir="exp/tldr/choice_qwen/pfl/fusionmoe_u5_1.0_${ema}/"
