...
do
  ...
  accelerate launch \
    ...
    eval.outdir "exp/tldr/choice_qwen/pfl_anal_round/multi_centralized_same_initial_1.0/round_${R}/raw" \
    outdir "exp/tldr/choice_qwen/pfl_anal_round/multi_centralized_same_initial_1.0/round_${R}/" \
    model.load_from_local_pretrained_model_path "checkpoints_1.0_oracle/final_tldr_choice_qwen_multi_centralized_same_initial_round_${R}.ckpt" \
