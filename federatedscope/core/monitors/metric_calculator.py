...
class MetricCalculator(object):
    ...
    def __init__(self, eval_metric: Union[Set[str], List[str], str]):
        ...
        self.eval_metric = self.get_metric_funcs(eval_metric)# return 형태: #{'acc': (<function eval_acc at 0x7f2edf2eb310>, True), 'avg_loss': (<function eval_avg_loss at 0x7f2edf2eb790>, False), 'loss': (<function eval_loss at 0x7f2edf2eb700>, False), 'total': (<function eval_total at 0x7f2edf2eb820>, False)}. 
        #acc, loss, avg_loss, total을 key로 가짐. total은  총 샘플 수. 
