...
def extend_data_cfg(cfg):
    ...
    # ================== 추가할 부분 시작 ==================
    # 이 부분을 함수의 적절한 위치에 추가합니다.
    
    # For caching pre-processed & splitted data to ensure fair comparison
    # 데이터 분할을 저장하고 로드하기 위한 설정
    cfg.data.save_splits = False
    cfg.data.load_splits = False
    cfg.data.splits_path = './final_data_splits'
