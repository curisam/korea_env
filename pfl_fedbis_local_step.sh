...
# ==========================
for R in 200 180 160 140 120 100 80 60 40 20  
do
  echo "=============================="
  ...
  accelerate launch \
    ...
    eval.outdir "exp/tldr/choice_qwen/pfl_anal_round/fedbis_1.0/round_${R}/raw" \
    outdir "exp/tldr/choice_qwen/pfl_anal_round/fedbis_1.0/round_${R}/" \
    model.load_from_local_pretrained_model_path "checkpoints_1.0_oracle/plain_fl/final_tldr_choice_qwen_fedbis_round_${R}.ckpt" \
